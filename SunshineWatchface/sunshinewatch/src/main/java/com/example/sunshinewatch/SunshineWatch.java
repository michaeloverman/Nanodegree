...
public class SunshineWatch extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            mNormalTextPaint = createTextPaint(resources.getColor(R.color.digital_text), NORMAL_TYPEFACE);

            mBoldTextPaint = new Paint();
            mBackgroundPaint = createTextPaint(resources.getColor(R.color.digital_text), BOLD_TYPEFACE);

            mSecondaryTextPaint = new Paint();
            mSecondaryTextPaint = createTextPaint(resources.getColor(R.color.secondary_text), NORMAL_TYPEFACE);
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            String text = mAmbient
                    ...
                    : String.format("%d:%02d", mCalendar.get(Calendar.HOUR),
                    mCalendar.get(Calendar.MINUTE));
            canvas.drawText(text, mXOffset, mYOffset, mNormalTextPaint);
        }
